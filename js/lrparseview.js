...
function formatInitialParseView(input, maximumStepCount) {
	var result = "<p><b>Sentence to be Parsed: </b><input class='form-control' id=\"input\" type=\"text\" size=\"" + input.length + "\" onkeyup=\"resize(this, 1);\" onchange=\"parseInput();\" value=\"" + input + "\"></p>";
	...
	result += "<input type=\"button\" class=\"btn btn-success btn-gerar btn-lg\" value=\"Parse\"><br><br>";
	result += "<br>";
	result += "<table class='table table-bordered'>";
	result += "<thead>";
	result += "<tr><th>S.No.</th><th>Stack</th><th>Input String</th><th>Action</th></tr>";
	result += "</thead>";
